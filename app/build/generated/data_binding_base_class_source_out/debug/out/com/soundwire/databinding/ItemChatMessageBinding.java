...
public final class ItemChatMessageBinding implements ViewBinding {
  ...
  @NonNull
  public final CircleImageView msgAvatar;
  ...
  private ItemChatMessageBinding(@NonNull LinearLayout rootView, @NonNull CircleImageView msgAvatar,
      @NonNull TextView msgText, @NonNull TextView msgTime) {
  ...
  public static ItemChatMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.msg_avatar;
      CircleImageView msgAvatar = ViewBindings.findChildViewById(rootView, id);
      if (msgAvatar == null) {
        break missingId;
      }
      ...
      return new ItemChatMessageBinding((LinearLayout) rootView, msgAvatar, msgText, msgTime);
    }
