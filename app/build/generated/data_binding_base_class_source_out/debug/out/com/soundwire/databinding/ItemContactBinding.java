...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull LinearLayout rootView, @NonNull Button btnChat,
      @NonNull CircleImageView ivAvatar, @NonNull TextView tvName, @NonNull TextView tvStatus) {
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((LinearLayout) rootView, btnChat, ivAvatar, tvName, tvStatus);
    }
